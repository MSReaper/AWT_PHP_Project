...
<h1 class="fw-bolder">Tell us how you feel</h1>

<p class="lead fw-normal text-muted mb-0">We like to hear from you..!</p>
...
<label for="inputMessage">Write About Us</label>
<br>
<br>

<button class="btn btn-primary " type="submit" name="submit">Send Feedback</button>
